...
<head>
    ...
    <link rel="stylesheet" href="./../Estilos/votacionCSS.css">
...
<body>
    <header>
        ...
        <form method="post" action="./../Vistas/cerrarSesion.php">
...
<h1>Quién es la mejor joven promesa del mundial?</h1>
    ...
    <div class="votos">
        <p class="alemania"><input type="radio" name="voto" value="Musiala" required><span>Musiala</span></p>
